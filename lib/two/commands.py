...
def define_commands():
    ...
    def cmd_meta_help(app, task, cmd, conn):
        ...
        conn.write({'cmd':'message', 'text':'Type to speak out loud (to nearby players). A message that begins with a colon (\u201C:dances\u201D) will appear as a pose (\u201CBelford dances\u201D). \u201C/me dances\u201D does the same.'})
